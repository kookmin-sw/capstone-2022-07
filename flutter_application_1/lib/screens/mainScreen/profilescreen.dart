...
class _ProfilescreenState extends State<Profilescreen>  {
  ...
  Widget profileimgandnickname(size, data){
     ...
     return Container(
       ...
       child: Column(
         children: [
           SvgPicture.asset('assets/icons/profileimg.svg', width:size.height*0.25
  ...
  Widget profilelogout(size){
     return InkWell(
       child: Container(decoration: const BoxDecoration(
         ...
         child : Row(
           children: [
             SvgPicture.asset('assets/icons/profilelogout.svg',width:size.height*0.04,
               color: CHART_MINUS
             ),SizedBox(width: size.width*0.04),
             Text('로그아웃',
               style: GoogleFonts.notoSans(fontSize: size.width*0.04),)
               ...
               width: size.width * 0.9,
                  ...
                  child: Column(
                    children: [
                      ...
                      profilealarm(size),SizedBox(height: size.height*0.01),
                      profilelogout(size),
                    ],
                  )
             );
