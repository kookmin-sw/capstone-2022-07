...
class _recentscreenState extends State<Recentscreen> {
  ...
  Widget build(BuildContext context) {
    ...
    return MaterialApp(
      title: "recentscreen",
      home: Scaffold(body: Builder(builder: (BuildContext ctx) {
...
Widget Navigationbar(var mediaQuery) {
  ...
  return Container(
      ...
      padding: EdgeInsets.symmetric(
          horizontal: size.width * 0.016, vertical: size.height * 0.008),
      child: Row(
              ...
              child: Stack(
                children: [
                  Align(
                      ...
                      child: SvgPicture.asset('assets/images/vectorset.svg',
          ...
          Container(
              ...
              child: Row(
                ...
                children: [
                  ...
                  Container(
                      child: SvgPicture.asset('assets/images/vectorcross.svg',
  ...
  return Expanded(
      child: ListView.builder(
          ...
          itemBuilder: (BuildContext context, int index) {
            return Stockcard(mediaQuery, '${Name[index]}', Price[index],
                '${Perc[index]}', Volume[index]);
          }));
}
